...
rejectJoinTeam_col = ""  --邀请组队界面中的取消图标主颜色
rejectJoinTeam_pos = ""  --邀请组队界面中的取消图标周边颜色
...
if width==1334 and height==750 then
  ...
  tansuo_col = "0x21170d"				--探索灯笼按钮主颜色
	...
	rejectJoinTeam_col = "0xdf6851"
	rejectJoinTeam_pos = "-85|-12|0x862748,83|42|0xc33d21,50|23|0xdf6851,-56|24|0xdf6851,-27|10|0x2a2521,25|17|0x3b2b25,-14|7|0xdf6851"
